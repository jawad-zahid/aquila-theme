    ...
    public function add_custom_meta_box($post)
    {
        ...
        foreach ($screens as $screen) {
            add_meta_box(
                ...
                $screen,                            // Post type
                'side',                            // Shows the meta in the side bar
            );
        }
    }
...
?>
        <label for="aquila_hide_title_field"><?php esc_html_e('Hide the page title', 'aquila'); ?></label>
...
<?php
    ...
    {
        /**
         * When the post is saved or updated we bet the $_POST available
         * Check if the current user is authorized to do this or not
         */
